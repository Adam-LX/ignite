...
describe("botTactics", () => {
	...
	it("assignBotRolesForTeam — jedyny bot zawsze striker", () => {
	...
	it("assignBotRolesForTeam — 2v2: bot striker nawet gdy human bliżej piłki", () => {
		const roles = assignBotRolesForTeam(
			[
				{ slotIndex: 0, distToIntercept: 4, isHuman: true },
				{ slotIndex: 2, distToIntercept: 18, isHuman: false },
			],
			2,
		);
