...
export const RL_CAR = {
	...
	flipVertDampStart: 0.15,
	/** W górę: ten sam damp tylko przez 8 ticków @ 120 Hz (Rocket Science #14) */
	flipVertUpDampTicks: 8,
	flipVertDampMul: 0.65,
	physicsTickHz: 120,
...
export const RL_BALL = {
	...
	groundFriction: 0.48,
	/** Korekta tunelu — ułamek prędkości po odbiciu (murawa RL, żywsza niż 0.4). */
	floorBounceRetain: 0.58,
	wallBounceRetain: 0.64,
	ceilingBounceRetain: 0.52,
	/** Max 6000 uu/s = 60 m/s */
	maxSpeed: 60,
	/** Sliding friction na murawie: 230 uu/s² = 2.3 m/s² */
	groundSlideDecel: 2.3,
	/** Rolling poniżej ~565 uu/s — wolniejszy zanik = dłuższe toczenie. */
	groundRollDecel: 0.08,
	airLinearDamp: 0.03,
	airAngularDamp: 0.1,
	...
	minHitSpeed: 0.35,
	/** Niższy próg — dribbling i rolling goal rejestrują kontakt. */
	minApproachSpeed: 0.85,
	/** Psyonix extra impulse — RocketSim / smish ball_simulation_3. */
	psyonixVertScale: 0.35,
	psyonixForwardRetain: 0.65,
	...
	moiScale: 0.4,
	/** Coulomb μ przy odbiciu — smish ball_simulation_1 / rl_ball_sym. */
	bounceFrictionMu: 2.0,
} as const;
...
export const RL_CAMERA = {
	...
	lookAhead: 1.35,
	lookAtCarOffsetY: 0.62,
	horizontalFov: 100,
	horizontalFovBoost: 106,
	swivelSpeed: 4.0,
