...
|---------|-------|
| W / S | Przód / tył |
| A / D | Skręt (ziemia) · yaw w powietrzu |
| Shift + A/D | Powerslide (ziemia) · beczka / air roll (powietrze) |
| Q / E | Air roll (bez Shift) |
| PPM | Skok / flip |
| LPM | Boost |
| Spacja | Ball Cam |
...
## Multiplayer (online 1v1 / 2v2)

Host tworzy pokój (tryb **1v1** lub **2v2**), gość dołącza kodem lub z listy otwartych pokoi. Symulacja działa u hosta; serwer pokojów łączy graczy i przekazuje wejścia/snapshoty.
...
W menu: **Online PvP** → Host (wybierz tryb) lub Dołącz. W LAN gość wpisuje IP hosta, np. `192.168.1.10:8765`.

**Publiczny relay (Cloudflare):** [`docs/MP_RELAY.md`](docs/MP_RELAY.md) — bake endpoint, named tunnel, daemon.

Ograniczenia MVP: ranked tylko 1v1, bez publicznego matchmakingu — wymagany dostęp do hosta (LAN / port-forward / relay).
