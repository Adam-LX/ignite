...
|-------|--------|----------|-------|
| Orbitron (UI) | `src/assets/fonts/Orbitron-Variable.ttf` | [SIL OFL 1.1](src/assets/fonts/Orbitron-OFL.txt) | Komercja OK; wcześniej Google Fonts CDN — usunięte |
| Wallpoet (logo IGN!TE na boisku) | `src/assets/fonts/Wallpoet-Regular.ttf` | [SIL OFL 1.1](src/assets/fonts/Wallpoet-OFL.txt) | Lars Berggren; graffiti display, komercja OK |
...
- ~~`fonts.googleapis.com` / `fonts.gstatic.com`~~ — zastąpione lokalnymi fontami OFL (Orbitron, Wallpoet).
